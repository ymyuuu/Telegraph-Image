		...
		336: function(t, e, o) {
			...
			var n = o(53),
				...
				m = {
					...
					mounted: function() {
						var t = this;
						this.pasteUpload(), this.copyBtn = new this.clipboard(this.$refs.copy), this
					...
					methods: {
						...
						clearFilelist: function() {
							this.status = "waitting", this.fileList = {}, document.getElementById(
								"upFiles").value = ""
						},
						focus: function() {
						...
						upload: function(t) {
							...
							o.append("file", t), r.a.post("/upload", o).then((function(t) {
								200 === t.status ? (e.status = "done", e.imgUrl = location
									.origin + t.data[0].src) : e.showError()
							})).catch((function() {
								e.showError()
							}))
						},
						clear: function() {
							this.file = {}, document.getElementById("upFiles").value = "", this.status =
								"waitting"
						},
						showError: function() {
							var t = this;
				...
				x = (o(334), Object(l.a)(w, (function() {
					...
					}, [e("Background"), this._v(" "), e("Header"), this._v(" "), e(
						"div", {
							staticClass: "main"
						}, [e("div", {
							staticClass: "title"
