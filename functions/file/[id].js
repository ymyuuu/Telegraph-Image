			...
			if (typeof env.img_url == "undefined" || env.img_url == null || env.img_url == "") {} else {
				...
				if (record.metadata === null) {
					...
					if (record.metadata.ListType == "White") {
						...
						if (typeof request.headers.get('Referer') == "undefined" || request.headers.get(
